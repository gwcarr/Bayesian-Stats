...
data_list <- list(N = length(iron$obs), price = iron$price, area = iron$area, roof = iron$roof, basmt = iron$basmt)

# EDA
iron |> select(price, roof, area, basmt) |> ggpairs()
```
...
fit$summary(variables = c('serr', 'beta0', 'barea', 'broof', 'bbasmt'))
